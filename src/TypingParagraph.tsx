...
import "./TypingEffect.css"; // Ensure the CSS is correctly imported
...
const TypingParagraph = () => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setIsVisible(true);
          // Set a timeout equal to the typing animation duration before showing the cursor
          setTimeout(() => setTypingComplete(true), 3000); // Adjust time to your typing effect duration
        }
      },
      {
        root: null,
  ...
  return (
    <div ref={ref} className={isVisible ? "typing-effect-container" : ""}>
      <span className={isVisible ? "typing-effect" : ""}>
        ...
        firmness his invasions on the rights of the people. He has refused for a
        ...
        cases, of the benefits of Trial by Jury: For transporting us beyond Seas
